...
public class LogHelperTransformer implements Opcodes {
    ...
    private static void insertInvoke(MethodNode node) {
        ...
        for (int localsIndex = length - 1; localsIndex >= lowestLocal;) {
        ...
        list.add(new MethodInsnNode(INVOKESTATIC, Type.getInternalName(AlexIILLibLog.class), "logInvoke", "([Ljava/lang/Object;)V", false));
    ...
    private static void insertReturn(MethodNode meth, AbstractInsnNode node) {
        ...
        list.add(new MethodInsnNode(INVOKESTATIC, Type.getInternalName(AlexIILLibLog.class), "logReturn", text, false));
    ...
    private static void insertIf(MethodNode meth, AbstractInsnNode node) {
        ...
        list.add(new MethodInsnNode(INVOKESTATIC, Type.getInternalName(AlexIILLibLog.class), "logIf", text, false));
        meth.instructions.insertBefore(node, list);
    }
